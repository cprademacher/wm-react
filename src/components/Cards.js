        ...
        <div className="cards__wrapper">
          ...
          <ul className="cards__items">
            <CardItem
              ...
              label="BUTTERMILK"
              path="/weather/buttermilk-mountain"
            />
            <CardItem
          ...
          <ul className="cards__items">
            <CardItem
              ...
              path="/weather/hesperus-ski-area"
            />
            <CardItem
              ...
              path="/weather/howelsen-hill-ski-area"
            />
            <CardItem
              ...
              path="/weather/kendall-mountain-ski-area"
            />
          </ul>
          <ul className="cards__items">
            <CardItem
            ...
            <CardItem
              ...
              path="/weather/loveland-ski-area"
            />
            <CardItem
          ...
          <ul className="cards__items">
            <CardItem
              ...
              label="POWDERHORN"
              path="/weather/powderhorn-mountain"
            />
            <CardItem
              ...
              label="PURGATORY"
              path="/weather/purgatory-mountain"
            />
            <CardItem
              ...
              path="/weather/silverton-mountain"
            />
          </ul>
          <ul className="cards__items">
            <CardItem
            ...
            <CardItem
              ...
              label="SNOWMASS"
              path="/weather/snowmass-mountain"
            />
            <CardItem
              ...
              label="STEAMBOAT"
              path="/weather/steamboat-mountain"
            />
          </ul>
          <ul className="cards__items">
            <CardItem
              ...
              path="/weather/sunlight-mountain"
            />
            <CardItem
              ...
              label="TELLURIDE"
              path="/weather/telluride-mountain"
            />
            <CardItem
          ...
          <ul className="cards__items">
            <CardItem
              ...
              label="WINTER PARK"
              path="/weather/winter-park-mountain"
            />
            <CardItem
              ...
              label="WOLF CREEK"
              path="/weather/wolf-creek-mountain"
            />
          </ul>
        </div>
      </div>
